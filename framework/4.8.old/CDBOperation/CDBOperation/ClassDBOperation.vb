...
Public Class CDBOperation
    ...
    Public Function GetDataIndividual(_conn As Object, _comm As Object, _reader As Object, _stSQL As String, Optional _checkPetik As Boolean = False) As Object
        'OK
    ...
    Public Function GetFormulationRecord(_conn As Object, _comm As Object, _reader As Object, _pFldName As String, _pTblName As String, Optional _formulationMethod As String = "Sum", Optional _pFilter As String = Nothing, Optional _dbType As String = "pgsql", Optional _groupByStatement As String = Nothing, Optional _checkPetik As Boolean = False) As Object
        'OK
        'untuk memperoleh jumlah isi dari sebuah field
        Dim stSQL As String
        Try
