...
Public Class CDBConnection
    ...
    Public Function SetAndOpenConnDB(_mType As String, ByRef _conn As Object, _prvdrType As String, _serverName As String, _dbName As String, Optional _sysDb As String = "", Optional _serverPort As Integer = 0, Optional _usrID As String = "", Optional _dbPsw As String = "", Optional _excelVersion As String = "xls", Optional _connType As String = "") As Boolean
        Try
            ...
            With _conn
                ...
                ElseIf (_mType = "ORACLE") Then
                    .ConnectionString = SetOracleConStr(_prvdrType, _serverName, _dbName, _serverPort, _usrID, _dbPsw)
                End If
            End With
    ...
    Public Function SetOracleConStr(_prvdrType As String, _serverName As String, _dbName As String, _serverPort As Integer, Optional _usrID As String = "", Optional _dbPsw As String = "") As String
        ...
        Try
            ...
            If (Trim(_dbPsw) = "") Then
                'tanpa Password
                '"Data Source=(DESCRIPTION = (ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.10.14)(PORT = 1521)))(CONNECT_DATA = (SERVICE_NAME = PROD)));User Id=apps;Password=apps"
                conSql = "Data Source=(DESCRIPTION = (ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST = " & _serverName & ")(PORT = " & _serverPort & ")))(CONNECT_DATA = (SERVICE_NAME = " & _dbName & ")));User Id=" & _usrID & ";Password=" & _dbPsw & ";"
            Else
            ...
            SetOracleConStr = conSql
        Catch ex As Exception
            SetOracleConStr = Nothing
            Call myCShowMessage.ShowErrMsg("Pesan Error: " & ex.Message, "SetOracleConStr Error")
        End Try
    End Function
