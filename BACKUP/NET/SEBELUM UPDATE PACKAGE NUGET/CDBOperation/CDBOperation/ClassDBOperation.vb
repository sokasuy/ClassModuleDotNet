...
Public Class CDBOperation
    ...
    Public Sub UpdateData(_conn As Object, _comm As Object, _tablename As String, _setString As String, Optional _whereString As String = "", Optional _checkPetik As Boolean = False)
        ...
        Try
            ...
            Call ExecuteNonQueryFunction(_comm, "UPDATE " & _tablename & " SET " & _setString & " WHERE " & _whereString)
        Catch ex As Exception
    ...
    Function DelDbRecords(_conn As Object, _comm As Object, _stTableName As String, Optional _stCrit As String = "", Optional _dbType As String = "pgsql", Optional _checkPetik As Boolean = False) As Boolean
        ...
        Try
            ...
            If (TypeOf _conn Is OleDb.OleDbConnection Or TypeOf _conn Is SqlConnection) Then
                If Not (Left(_stTableName, 1) = "[") Then
        ...
        Try
            ...
            If (TypeOf _conn Is OleDb.OleDbConnection Or TypeOf _conn Is SqlConnection) Then
                ...
                If (Xist = 0) Then
                    ...
                    If (Xist = 0) Then
                        If Not (Left(Trim(_stTableName), 1) = "[") Then 'bermasalah kalau ada deklarasi alias >>> 14Sep11 ditambahkan pengecekan alias dulu
                            _stTableName = "[" & _stTableName & "]"
                        End If
                    End If
        ...
        Try
            ...
            If (TypeOf _conn Is OleDb.OleDbConnection Or TypeOf _conn Is SqlConnection) Then
                ...
                If (Xist = 0) Then
                    ...
                    If (Xist = 0) Then
                        If Not (Left(Trim(_tableName), 1) = "[") Then 'bermasalah kalau ada deklarasi alias >>> 14Sep11 ditambahkan pengecekan alias dulu
        ...
        Try
            ...
            If (TypeOf _conn Is OleDb.OleDbConnection Or TypeOf _conn Is SqlConnection) Then
                ...
                If (Xist = 0) Then
                    ...
                    If (Xist = 0) Then
                        If Not (Left(_pTableName, 1) = "[") Then 'bermasalah kalau ada deklarasi alias >>> 14Sep11 ditambahkan pengecekan alias dulu
    ...
    Public Sub SaveUpdatedAt(_conn As Object, _comm As Object, _reader As Object, ByRef _newValues As String, _dbaseTbl As String, Optional _tipeDB As String = "access")
        'OK
        Try
    ...
    Public Sub EditUpdatedAt(_conn As Object, _comm As Object, _reader As Object, ByRef _updateString As String, _dbaseTbl As String, Optional _tipeDB As String = "access")
        'OK
        Try
    ...
    Public Function SetAutoKode(_conn As Object, _comm As Object, _reader As Object, _tblName As String, _prefixKode As String, Optional _tipeDB As String = "access") As String
        Try
        ...
        Try
            ...
            If (_tipeDB = "pgsql") Then
                stSQL = "SELECT (" & _tblName & "." & _kodeField & ") " &
                        "FROM (" & _tblName & ") " &
                        "WHERE " & _tblName & "." & _kodeField & " like '" & _prefixKode & "%'" &
    ...
    Public Function SetDynamicKDR(_conn As Object, _comm As Object, _reader As Object, _tblName As String, _kodeField As String, _idField As String, _prefixDate As Date, _identityValue As String, _digitLength As Integer, Optional _tipeDB As String = "access") As String
        Try
            Dim mCountAddZero As Integer
            Dim zeroNumber As String
            Dim myAutoKode As String
