...
Public Class CDBConnection
    ...
    Public Sub SetAndOpenConnForExcel(ByRef _conn As OleDb.OleDbConnection, _dataSource As String, _excelVersion As String, _prvdrType As String)
        'OK
        Try
            ...
            Select Case _prvdrType
                Case "3.51"
                    stProvider = "Provider=Microsoft.Jet.OLEDB.3.51;" 'utk Access 97  : Microsoft.Jet.OLEDB.3.51 = MSJET35.DLL 24-Apr-1998, di \system32\
                Case "4.0"
                    stProvider = "Provider=Microsoft.Jet.OLEDB.4.0;" 'utk Access 2000 - 2003
                Case "12.0"
